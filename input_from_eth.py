...
class ProverPayload:
    ...
    def lido_operators_in_eth(self):
        validators = [
            self.beacon_state.find_validator(operator.key_hex)
    ...
    def to_cairo(self) -> ProverPayloadSerialized:
        return {
            ...
            "beacon_state_mtr": self.beacon_state.merkle_tree_root().to_cairo(),
            "validator_keys": self.lido_operators.to_cairo(),
            "validator_keys_mtr": self.lido_operators.merkle_tree_root().to_cairo(),
